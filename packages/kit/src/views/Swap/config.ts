...
export const networkProviderInfos: Record<string, Provider[]> = {
  [OnekeyNetwork.okt]: [
    {
      name: 'CherrySwap',
      logoUrl: 'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/logo/CherrySwap.png',
    },
  ],
  [OnekeyNetwork.heco]: [
    {
      name: 'MDex',
      logoUrl: 'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/logo/MdexSwap.png',
    },
  ],
  [OnekeyNetwork.xdai]: [
    {
      name: 'HoneySwap',
      logoUrl: 'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/logo/HoneySwap.png',
    },
  ],
};
...
const WETH = {
  ...
  decimals: 18,
  logoURI:
    'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/token/evm-1/0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2.jpg',
  impl: 'evm',
  chainId: '1',
} as ServerToken;
...
const WBNB = {
  ...
  decimals: 18,
  logoURI:
    'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/token/evm-56/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c.jpg',
  impl: 'evm',
  chainId: '56',
} as ServerToken;
...
const WMATIC = {
  ...
  decimals: 18,
  logoURI:
    'https://drag2.s3.ap-east-1.amazonaws.com/pocket/Npay/token/evm-137/0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270.jpg',
  impl: 'evm',
  chainId: '137',
} as ServerToken;
